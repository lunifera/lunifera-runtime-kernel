...
public class ConfigurationManagerExtenderIntegrationTest extends
    ...
    public void ensureExternalPidInProperties() throws IOException {
        ...
        LuniferaFrameworkConfigurationManagementService cms = ServiceUtils
                .getService(bc,
                        LuniferaFrameworkConfigurationManagementService.class);
        ...
        String externalPid = (String) findFactoryConfigurations(HELPER_FACTORY_PID)[0]
                .getProperties()
                .get(LuniferaFrameworkConfigurationManagementService.EXTERNAL_PID);
    ...
    public void ensureServicesWasRegistered() {
        ...
        assertServiceAvailable(
                ...
                "org.lunifera.runtime.kernel.api.configuration.LuniferaFrameworkConfigurationManagementService");
    }
