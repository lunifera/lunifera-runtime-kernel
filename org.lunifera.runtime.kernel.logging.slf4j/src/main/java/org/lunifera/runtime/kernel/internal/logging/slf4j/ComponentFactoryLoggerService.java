...
public class ComponentFactoryLoggerService implements Logger {
    ...
    void activate(ComponentContext ctx) {
        ...
        loggerName = (String) ctx.getProperties().get(
                KernelConstants.LUNIFERA_LOGGER_NAME);
        ...
        getLogger().debug("Logger for component '{}' was activated.({})",
    ...
    protected void unbindILoggerFactory(ILoggerFactory loggerFactory) {
        // TODO to avoid components to loose log messages I will backup the root
        // logger.
