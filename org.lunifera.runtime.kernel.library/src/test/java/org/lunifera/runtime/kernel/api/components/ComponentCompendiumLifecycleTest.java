...
public class ComponentCompendiumLifecycleTest {
    ...
    static class AnComponent extends AbstractComponentCompendium {
    ...
    AbstractComponentCompendium concreteComponent;
    ...
    public void ensureCompendiumTrackersAreBeingUsedWhenThereIsNoDsInjectingThingsBeforeActivate()
        ...
        inOrder.verify(concreteComponent).activate(any(ComponentContext.class));
