...
public class ExtenderComponentLifecycleTest {
    ...
    private Dictionary<String, Object> getMockProperties() {
        ...
        dict.put(KernelConstants.EXTENDER_SERVICE_ATTR_MANIFEST_HEADER_NAME,
                "MyHeader");
        ...
        dict.put(KernelConstants.EXTENDER_SERVICE_LOOKUP_STATE_MASK,
                Bundle.ACTIVE);
        dict.put(
                ...
                ContributionItemResourceType.PROPERTIES_FILE_RESOURCE
                        .getIdent());
        dict.put(
                KernelConstants.EXTENDER_SERVICE_ATTR_CONTRIBUTION_HANDLER_SERVICE,
                "org.lunifera.runtime.kernel.spi.extenders.handlers.ComponentContributionHandlerPropertiesFileResourcePerItemWithConfigAdmin");
